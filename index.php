...
<?= startHTML('Halaman Admin Data Mahasiswa') ?>
<style>
  body[data-mode='dark'] {
  ...
  <div class="row">
    <div class="col-md-3">
      <div class="cari-data position-relative">
        <input type="text" class="form-control mb-4 search" name="cari" autocomplete="off" placeholder="Cari Data Mahasiswa" />
        <!-- icon search -->
      ...
      <div class="user">
        ...
        <div class="icon-person">
          ...
          Selamat Datang, <b class="text-primary"><?= isset($username) ? $username : '' ?> &nbsp;</b>
    ...
    <?php foreach ($mahasiswa as $mhs) : ?>
      ...
      <tr>
        ...
        <td>
          ...
          <!-- hapus data -->
          <a href="hapus.php/<?= $mhs['id']; ?>/<?= $mhs['gambar']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('yakin ingin hapus data ini?')">
        ...
        <!-- gambar -->
        <td>
          <img src="upload-gambar/<?= $mhs['gambar']; ?>" alt="gambar mahasiswa" width="35" height="35" />
        </td>
      </tr>
    <?php endforeach; ?>
  </tbody>
